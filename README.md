...
## Environments
- Preview: https://main--blefebvr-citizens-bank--aemysites.aem.page/
- Live: https://main--blefebvr-citizens-bank--aemysites.aem.live/
- Block Library: https://main--blefebvr-citizens-bank--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `blefebvr-citizens-bank` directory in your favorite IDE and start coding :)
